...
export const DOCTORS: Doctor[] = [
  ...
  },
  {
    id: 'doc-arvind',
    name: 'Dr. Arvind Shah',
    specialization: 'Consulting Physician & Clinical Specialist',
    initials: 'AS',
    avatarColor: 'linear-gradient(135deg,#0284C7,#0369A1)',
    room: 'Cabin 5 (Room 105)',
    email: 'arvind.shah@medflow.health',
    phone: '+91 98251 00007',
    qualification: 'MBBS, MD (Medicine), FCCP',
    registrationNumber: 'G-38910',
    consultationFee: 500,
    followUpFee: 300,
    emergencyFee: 1000,
    teleconsultationFee: 500,
    followUpValidityDays: 7,
    slotDurationMins: 15,
    schedule: 'Mon–Sat: 09:30 AM – 01:30 PM & 04:30 PM – 08:30 PM',
    status: 'ACTIVE',
  ...
  },
  {
    id: 'doc-test',
    name: 'Dr. Test User',
    specialization: 'Senior Resident & General Physician',
    initials: 'TU',
    avatarColor: 'linear-gradient(135deg,#8B5CF6,#7C3AED)',
    room: 'Cabin 6 (Room 106)',
    email: 'test.user@medflow.health',
    phone: '+91 98251 00008',
    qualification: 'MBBS, DNB',
    registrationNumber: 'G-51204',
    consultationFee: 500,
    followUpFee: 300,
    emergencyFee: 800,
...
const PATIENTS: Patient[] = [
  { id: 'pat-1', mrdNumber: 'MRD-2026-0001', firstName: 'Mahesh', middleName: 'K.', lastName: 'Kumar', mobile: '9825100001', age: 45, ageMonths: 0, ageDays: 0, gender: 'M', language: 'Gujarati', bloodGroup: 'B+', city: 'Surat', dob: '1981-04-13', createdAt: '2024-01-15', lastVisit: '2026-03-25', tags: ['VIP'], category: 'VIP', allergies: 'Penicillin', address: '12, Shanti Nagar, Adajan, Surat', email: 'mahesh.k@gmail.com', emergencyContact: 'Suman Kumar (Wife) - 9825100011' },
  ...
  { id: 'pat-3', mrdNumber: 'MRD-2026-0001', firstName: 'Mahesh', middleName: 'K.', lastName: 'Kumar', mobile: '9825100001', age: 45, ageMonths: 0, ageDays: 0, gender: 'M', language: 'Gujarati', bloodGroup: 'B+', city: 'Surat', dob: '1981-04-13', createdAt: '2024-01-15', lastVisit: '2026-03-25', tags: ['VIP'], category: 'VIP', allergies: 'Penicillin', address: '12, Shanti Nagar, Adajan, Surat', email: 'mahesh.k@gmail.com', emergencyContact: 'Suman Kumar (Wife) - 9825100011' },
  ...
  { id: 'd31bf791-c69d-4411-90be-6a0cba820ec6', mrdNumber: 'MRD-2026-0021', firstName: 'harshad', middleName: '', lastName: 'harshad', mobile: '9888888888', age: 0, ageMonths: 0, ageDays: 0, gender: 'M', language: 'Gujarati', bloodGroup: '', city: '', state: 'Gujarat', address: '', emergencyContact: '', maritalStatus: '', occupation: '', allergies: 'No Known Allergies', category: 'Regular', tags: [], createdAt: '2026-09-21', lastVisit: '2026-09-26', isNew: false },
];
const QUEUE_ENTRIES: QueueEntry[] = [
  { id: 'q-harshad', caseNumber: 'C001-005-260926', tokenDisplay: 'C005', patientId: 'd31bf791-c69d-4411-90be-6a0cba820ec6', patientName: 'harshad harshad', doctorId: 'doc-arvind', doctorName: 'Dr. Arvind Shah', visitType: 'Consultation', appointmentTime: '03:40 PM', checkInTime: '03:40 PM', age: 0, gender: 'M', city: '', billingStatus: 'PENDING', status: 'WAITING', vitalsRecorded: false, complaintsRecorded: false },
...
const BILLS: BillRecord[] = [
  ...
  { id: 'bill-4', invoiceNumber: 'INV-2026-0090', patientId: 'pat-3', patientName: 'Mahesh Kumar', mrdNumber: 'MRD-2026-0001', doctorName: 'Dr. Raj Valaki', date: '2026-09-19', netAmount: 500, collectedAmount: 500, balance: 0, status: 'PAID', paymentMode: 'UPI', items: [{ id: 'i6', name: 'Consultation Fee', unitPrice: 500, quantity: 1, discount: 0, total: 500 }] },
  ...
  persist(
    (set, get) => ({
      ...
      getPatientById: (id) => {
        ...
        if (id === 'd31bf791-c69d-4411-90be-6a0cba820ec6') {
          return {
            id: 'd31bf791-c69d-4411-90be-6a0cba820ec6',
            mrdNumber: 'MRD-2026-0021',
            firstName: 'harshad',
            middleName: '',
            lastName: 'harshad',
            mobile: '9888888888',
...
export { PATIENTS, QUEUE_ENTRIES, BILLS, NOTIFICATIONS, SLOTS };
